...
<div class="window glass transparent" style="">
  ...
  <div class="window-body">
    <menu role="tablist">
      <button role="tab" id="meTab" aria-controls="me" @click="toggleTab(1)" aria-selected="true">About me</button>
      <button role="tab" id="projectTab" aria-controls="project" @click="toggleTab(2)" aria-selected="false">Projects</button>
      <button role="tab" id="funTab" aria-controls="fun" @click="toggleTab(3)" aria-selected="false">Fun stuff</button>
    </menu>
    <article role="tabpanel" id="me">
      <div class="container">
        <div id=headerContainer>
          <img src="https://upload.wikimedia.org/wikipedia/commons/e/e0/SNice.svg"
           alt="A picture of Alex" height="50px" width="50px">  
          <h4 id="nameHeader" >Alex Holm</h4>
          <h6 id="jobHeader" >Software Engineer</h6>
  ...
  export default {
    data() {
      return {
        ...
        projectTab:  document.getElementById("projectTab"),
        funTab:  document.getElementById("funTab")
      }
    },
    methods: {
      testClick() {
