...
<div class="window" style="max-width: 400px">
  ...
  <div class="window-body">
    <menu role="tablist">
      <button role="tab" aria-controls="music" @click="toggleTab(1)" aria-selected="true">Music</button>
      <button role="tab" aria-controls="dogs" @click="toggleTab(2)" aria-selected="false">Dogs</button>
      <button role="tab" aria-controls="food" @click="toggleTab(3)" aria-selected="false">Food</button>
    </menu>
