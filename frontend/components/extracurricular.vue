<template>
  <div class="window glass transparent" style="width 60%">
    ...
    <div class="window-body">
      ...
      and moderating the weekly guest lectures. He was also instrumental in
      planning and executing the 2019 Winter Hackathon. QUT White Hats
